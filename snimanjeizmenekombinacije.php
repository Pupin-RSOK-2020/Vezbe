          ...
          if ($dobrouneta)
            {
              ...
              /*izmena objekta u bazi metodom promeniKombinaciju*/
              $result = $objKombinacija->promeniKombinaciju($rb);
              if ($result)
              {
                echo '<br/><br/><b>';
                echo "Kombinacija je uspešno promenjena u bazi podataka!";
                echo '</b><br/>';
              }
              else
              {
                echo '<br/>';	
                echo "Kombinacija nije promenjena u bazi podataka!";	
                echo '<br/>';				
              }
            }
            }
